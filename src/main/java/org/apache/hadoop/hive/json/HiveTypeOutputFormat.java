...
public class HiveTypeOutputFormat<K,V> extends FileOutputFormat<K, V> {
        ...
        public RecordWriter<K, V> getRecordWriter(TaskAttemptContext job) throws IOException, InterruptedException {
            ...
            if(isCompressed){
                return new HiveTypeRecordWriter<>(new DataOutputStream(codec.createOutputStream(fileOut)), fieldSeparator,recordSeparator);
            }else{
                return new HiveTypeRecordWriter<>(fileOut, fieldSeparator,recordSeparator);
            }
        }
